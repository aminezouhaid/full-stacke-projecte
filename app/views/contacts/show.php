...
<div class="bg-secondary text-white p-2 mb-3">
  <!-- Written by <?php echo $data['contact']->name; ?> on <?php echo $data['contact']->created_at; ?> -->
</div>
<p><?php echo $data['contact']->email; ?></p>
<p><?php echo $data['contact']->number; ?></p>
<p><?php echo $data['contact']->address; ?></p>
